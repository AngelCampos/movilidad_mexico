...
ui <- fluidPage(
    ...
    sidebarLayout(
        ...
        fluidRow(h4("Datos abiertos: ", a(href="https://www.apple.com/covid19/mobility", "Apple Mobility Trends Reports.")), paste("Última actualización de datos:", max(mxDATA$day))),
            ...
            hr(),
            fluidRow(p("Esta aplicación grafica el porcentaje de movilidad diario por estado y para algunas ciudades de México.",
                       "El punto de referencia (0%) es la movilidad calculada para el día lunes, 13 de enero del 2020, en cada región"),
                     p("Para graficar los valores de distintas regiones, usa el menú inferior para seleccionar los",
